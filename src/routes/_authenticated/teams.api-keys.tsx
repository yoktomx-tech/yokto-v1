    ...
    return (
      <div className="rounded-lg bg-yo-surface border border-yo-border p-10 text-center shadow-sm">
        ...
        <p className="mt-1 text-[13px] text-yo-txt-2 max-w-md mx-auto">
          Actualiza tu plan para conectar YOKTO con tu ERP, TMS o sistema interno mediante API REST y webhooks.
        </p>
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[12.5px] text-yo-txt-3">Conecta YOKTO con tu ERP, CRM, TMS o sistema interno.</p>
        </div>
