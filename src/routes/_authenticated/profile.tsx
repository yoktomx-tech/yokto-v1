...
export const Route = createFileRoute("/_authenticated/profile")({
  head: () => ({ meta: [{ title: "Mi perfil — YOKTO" }, { name: "robots", content: "noindex" }] }),
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-5">
      <PageHeader
        icon={UserRound}
        title="Mi perfil"
        subtitle="Tu identidad, datos fiscales, cuenta bancaria y reputación dentro de YOKTO."
      />
        ...
        {!primary ? (
          <div className="text-center py-6">
            ...
            <p className="text-[12.5px] text-yo-txt-3 mt-1 max-w-md mx-auto">
              Agrega una CLABE para recibir pagos, devoluciones o liberaciones dentro de YOKTO.
            </p>
            <Link
