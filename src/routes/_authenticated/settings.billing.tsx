...
function BillingPage() {
  return (
    <div className="space-y-4">
      <SettingsCard icon={CreditCard} title="Plan activo" description="YOKTO no custodia fondos ni emite CFDI de operaciones entre comprador y vendedor. La facturación aquí corresponde a la suscripción al SaaS.">
      ...
      <SettingsCard icon={FileText} title="Perfil fiscal de billing" description="Datos que YOKTO usará para emitir tu CFDI de suscripción.">
