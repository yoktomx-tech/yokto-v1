...
export const Route = createFileRoute("/_authenticated/analytics/fiscal")({
  head: () => ({ meta: [{ title: "Fiscal — Analytics — YOKTO" }, { name: "robots", content: "noindex" }] }),
    ...
    <div className="space-y-6">
      <div className="rounded-lg border border-yo-warn bg-[#FFFBEB] p-3">
        <p className="text-[12px] text-[#92400E]">
          YOKTO no emite CFDI ni REP. El vendedor los timbra en su PAC y los sube a la plataforma; nosotros validamos coherencia contra la operación.
        </p>
      </div>
        ...
        <div className="rounded-lg border border-yo-border overflow-x-auto">
          <table className="w-full text-[12.5px]">
            <thead className="bg-yo-raised text-yo-txt-2">
              <tr>
                {["Tipo", "UUID", "Operación", "Emisor", "Total", "Método", "SAT", "Coherencia", "Estado YOKTO", "Parc.", ""].map(h =>
        ...
        <>
          ...
          <aside className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-yo-surface border-l border-yo-border shadow-xl overflow-y-auto">
            ...
            <div className="p-5 space-y-3 text-[13px]">
              ...
              <Row k="Estado YOKTO" v={<DotBadge tone={YO_CFG[detail.estado].tone}>{YO_CFG[detail.estado].label}</DotBadge>} />
